...
from core.dependencies import get_films_dependency
...
@router.get(
    "",
    response_model=PaginatedResponse[FilmShort],
...
async def films_list(
    service: FilmService = Depends(get_films_dependency),
