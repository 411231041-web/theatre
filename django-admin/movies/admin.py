...
class PersonAdmin(admin.ModelAdmin):
    """
    Админ-класс для управления участниками кинопроизведения (актёры, режиссёры, сценаристы).
...
class GenreFilmWorkInline(admin.TabularInline):
    ...
    Позволяет добавлять и удалять жанры непосредственно из формы редактирования фильма.
    Оснащен автозаполнением для строкол на онове поля жанра.
    """
    model = GenreFilmWork
...
class PersonFilmWorkInline(admin.TabularInline):
    """
    Встроенный админ-класс для эдитирования связей между фильмами и участниками.

    Позволяет добавлять и удалять актёров, режиссёров и сценаристов непосредственно
    из формы редактирования фильма. Оснащен выбором роли и автозаполнением для участника.
    """
...
class FilmWorkAdmin(admin.ModelAdmin):
    ...
    Обеспечивает ваюрди, редактирование, делетирование, табулярное эдитирование связей с
    жанрами и участниками, а также фильтрацию и поиск.
    ...
    def get_queryset(self, request):
        ...
        Презагружает связанные жанры для уменьшения количества запросов к базе данных.
    ...
    def get_genres(self, obj):
        ...
        Названия жанров отображаются в листвие моделей админ-панели через тот же метод.
